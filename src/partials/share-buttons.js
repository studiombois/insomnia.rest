...
export const Twitter = ({ title }) => (
  <Link
    ...
    onClick={e => {
      e.preventDefault();
      const href = `http://twitter.com/share?url=${encodeURIComponent(
        window.location.href
      )}&text=${encodeURIComponent(title || document.title)}&via=GetInsomnia`;
...
export const Reddit = ({ title }) => (
  <Link
    ...
    onClick={e => {
      e.preventDefault();
      const href = `http://reddit.com/submit?url=${encodeURIComponent(
        window.location.href
...
export const Facebook = ({ title }) => (
  <Link
    ...
    onClick={e => {
      e.preventDefault();
      const href = `http://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(
        window.location.href
      )}`;
