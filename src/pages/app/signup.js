  ...
  renderStep1() {
    ...
    return (
      <div key="step-1">
        ...
        <div className="form-control">
          <label>
            Password * <span className="subtle">(minimum 8 characters)</span>
            <input
              type="password"
              name="password"
              onChange={this._handleUpdateInput.bind(this)}
      ...
      <div key="step-2">
        <div className="form-control">
          <p className="notice warn small">
            ...
            <br />
            <Link to="https://insomnia.rest/documentation/plus/">
              Read More
            </Link>{' '}
        ...
        <div className="form-control right">
          <label>
            ...
            />
            I agree to the{' '}
            <Link to="https://insomnia.rest/terms/" target="_blank">
              Terms of Service
            </Link>
          </label>
        </div>
        ...
        <div className="form-row padding-top-sm">
          <div className="form-control">
            <Link to="#" onClick={this._handleBack.bind(this)}>
              &lt; Back
            </Link>
          </div>
          <div className="form-control right">
...
export default () => (
  <App
    noAuth
    title="Sign Up"
    subTitle="Access data sync and other features 🌥"
    hideFooter={true}>
    {props => <SignUp {...props} />}
  </App>
);
