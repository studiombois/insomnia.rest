...
class DeleteAccount extends React.Component {
  ...
  async _handleSubmit(e) {
    ...
    if (
      !confirm(
        'Are you sure you want to delete your account and all its associated data? This operation cannot be undone'
      )
    ) {
      return;
    }
  ...
  render() {
    ...
    return (
      <form onSubmit={this._handleSubmit.bind(this)}>
        <p>
          Really delete account for <code>{whoami.email}</code>? Once deleted,
        ...
        <div className="form-control padding-top-sm right">
          {loading ? (
            <button type="button" disabled className="button danger">
              Deleting...
            </button>
          ) : (
...
export default () => (
  <App
    ...
    subTitle="You have the right to be forgotten">
