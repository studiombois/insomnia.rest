      ...
      <div className="container">
        <div className="row">
          <div className="col-12 center">
            <h1>
              Debug APIs like a <span className="jumbotron__undie">human</span>,
              not a robot
            </h1>
        ...
        <div className="jumbotron__img-container">
          <Img
            sizes={data.mainImg.childImageSharp.sizes}
    ...
    <main role="main">
          ...
          <div className="row">
            <div className="col-12">
              ...
              <p
                ...
                <strong>Free</strong> and <strong>open source</strong> on Mac,
                Windows, and Linux
              </p>
            </div>
          </div>
          <div className="row">
            <div className="col-4 padding-top">
              <div className="img--promo">
                <Img
                  sizes={data.templateImg.childImageSharp.sizes}
                  alt="Request Templating"
                />
              </div>
              <h3>Create HTTP requests</h3>
              <p>
                Specify URL, payload, headers, and authorization all in one
                place. Then just hit send.
              </p>
            </div>
            <div className="col-4 padding-top">
              <div className="img--promo">
                <Img
                  sizes={data.responsesImg.childImageSharp.sizes}
            ...
            <div className="col-4 padding-top">
              <div className="img--promo">
                <Img
                  sizes={data.dragImg.childImageSharp.sizes}
                  alt="Request Organization"
                />
              </div>
      ...
      <section className="dark no-margin padding-bottom-lg padding-top-lg">
        <div className="container center">
          <div className="row">
            <div className="col-12">
              <h2 className="text-xxl">Much more than an HTTP client</h2>
              <p
                className="text-lg"
                style={{ maxWidth: '35rem', margin: 'auto' }}>
                Advanced authentication helpers, templating, and request
                chaining help get things done faster.
                <br />
                <br />
