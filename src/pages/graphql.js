...
export default ({
  data: { mainImg, errorsImg, autocompleteImg, variablesImg }
}) => (
  <React.Fragment>
        ...
        <div className="container slogan">
          <div className="row">
            <div className="col-12 center">
              <h1 className="font-regular">GraphQL + Insomnia</h1>
          ...
          <div className="container">
            <Img
              sizes={mainImg.childImageSharp.sizes}
              className="jumbotron__img"
              alt="Insomnia GraphQL IDE"
            />
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h2 className="text-xxl">GraphQL and Beyond 🚀</h2>
            <p className="text-lg">
              GraphQL <strong>autocomplete</strong> and <strong>linting</strong>{' '}
              plus Insomnia's HTTP tool belt
            </p>
          </div>
        </div>
        <div className="row">
          <div className="col-4 padding-top">
            <div className="img--promo">
              <Img
                sizes={autocompleteImg.childImageSharp.sizes}
                alt="GraphQL Autocomplete"
              />
            </div>
            <h3>Query Completion</h3>
            <p>
              Autocomplete of field names and arguments makes constructing
          ...
          <div className="col-4 padding-top">
            <div className="img--promo">
              <Img
                sizes={errorsImg.childImageSharp.sizes}
                alt="GraphQL Error Checking"
              />
            </div>
            <h3>Error Checking</h3>
            <p>
              Schema-based error checking prevents you from making mistakes
          ...
          <div className="col-4 padding-top">
            <div className="img--promo">
              <Img
                sizes={variablesImg.childImageSharp.sizes}
                alt="GraphQL with Insomnia's Features"
              />
            </div>
            <h3>Advanced Features</h3>
            <p>
              Insomnia's existing features like template tags, environments, and
      ...
      <div className="container">
        <div className="row padding-top padding-bottom-lg">
          <div className="col-12 center">
            ...
            <p className="text-lg">
              Insomnia is free, open source, and cross-platform
            </p>
...
export const pageQuery = graphql`
  query GraphQLImageQuery {
    ...
    autocompleteImg: file(
      relativePath: { eq: "screens/graphql-autocomplete.png" }
    ) {
      childImageSharp {
        sizes(maxWidth: 250) {
